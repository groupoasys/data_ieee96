...
- [congestion_capx1.csv](congestion_capx1.csv): congestion data of transmission lines for original capacity limits

- [congestion_capx2.csv](congestion_capx2.csv): congestion data of transmission lines if capacity limits are doubled

- [congestion_capx05.csv](congestion_capx05.csv): congestion data of transmission lines if capacity limits are halved
